    ...
    >
      ...
      >
        ...
        <div style={{ padding: '1.5rem', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          {/* Collapsible Supabase Project Configuration Section */}
          <div
            style={{
              marginTop: '0.5rem',
              borderRadius: '12px',
          ...
          >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Database size={15} style={{ color: isConfigured ? '#34d399' : 'var(--accent)' }} />
                ...
                <span
                  style={{
                    ...
                    padding: '2px 6px',
                    borderRadius: '4px',
                    backgroundColor: isConfigured ? 'rgba(52, 211, 153, 0.15)' : 'rgba(245, 158, 11, 0.15)',
                    color: isConfigured ? '#34d399' : '#fbbf24',
                    fontWeight: 700
                  }}
                >
                  {isConfigured ? t.connected : t.notConnected}
                </span>
              </div>
            ...
            {showConfig && (
              <div style={{ padding: '0 1rem 1rem', borderTop: '1px solid var(--border-subtle)' }}>
                <p style={{ fontSize: '0.78rem', color: 'var(--text-tertiary)', margin: '0.8rem 0 1rem', lineHeight: 1.4 }}>
                  {t.supabaseConfigSubtitle}
                </p>
                ...
                <form onSubmit={handleSaveConfig} style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
                  ...
                  {configSuccess && (
                    <div style={{ fontSize: '0.8rem', color: '#34d399', display: 'flex', alignItems: 'center', gap: '6px' }}>
                      ...
                      {uiLang === 'ta' ? 'அமைப்புகள் வெற்றிகரமாக சேமிக்கப்பட்டது!' : 'Credentials saved successfully!'}
                    </div>
                  )}
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginTop: '4px' }}>
                    ...
                    {isConfigured && config.source === 'storage' && (
                      <button
                        type="button"
                        onClick={() => {
                          removeConfig();
                ...
                >
                  <strong style={{ color: 'var(--text-secondary)' }}>
                    {uiLang === 'ta' ? '3 எளிய படிகள்:' : 'Quick 3-step setup:'}
                  </strong>
                  <ol style={{ margin: '4px 0 0', paddingLeft: '1.2rem' }}>
                    <li>
                      {uiLang === 'ta' ? 'supabase.com-ல் இலவச கணக்கு தொடங்கி புதிய திட்டம் தொடங்கவும்' : 'Sign up free at supabase.com and create a project'}
                    </li>
                    <li>
                      {uiLang === 'ta' ? 'Project Settings > API-ல் Project URL மற்றும் Anon Key-ஐ நகலெடுக்கவும்' : 'Copy Project URL & Anon Key from Settings > API'}
                    </li>
                    <li>
                      {uiLang === 'ta' ? 'Authentication > Providers > Google-ல் Google உள்நுழைவை இயக்கவும்' : 'Enable Google provider in Authentication > Providers'}
                    </li>
                  </ol>
                </div>
              </div>
